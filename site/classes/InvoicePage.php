...
class InvoicePage extends Page {
	 ...
	 * 
	 */
	public function getDueDate($formatted = false): int|false|string {
	 ...
	 * 
	 * @return int|float|false Returns days remaining or false on error
	 * 
	 */
	public function getDaysRemaining(): int|float|false {
	 ...
	 * 
	 */
	public function getPaidInDays(): int|float|false {
	 ...
	 * 
	 */
	public function addLineItem($type, $description, $qty, $rate): InvoiceItemsRepeaterPage {
	 ...
	 * 
	 */
	public function addPayment($date, $amount, $description): InvoicePaymentsRepeaterPage {
	 ...
	 * 
	 */
	public function addLog($line, $saveNow = false): void {
		$line = str_replace("\n", " ", $line);
